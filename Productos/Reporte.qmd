...
Hoy en día existen páginas y plataformas en línea para practicar, disfrutar y competir en este aclamado juego de estrategia, en las que se empareja a dos jugadores con un nivel competitivo basado en el sistema de clasificación Elo.
...
```{r}
#| echo: false
data.frame(Variable = c("Turnos", "Ganador", "white_rating (Elo Blancas)", "Elo Negras", "Diferencia de Elo", "Elo promedio"),
